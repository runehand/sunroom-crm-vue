...
A full-featured customer relationship management application built with Vue 3, Vuetify 4, and Pinia. This is the Vue frontend for Sunroom CRM, backed by a .NET 8 REST API with SQL Server.
...
| [sunroom-crm-angular](https://github.com/runehand/sunroom-crm-angular) | Angular 21, Material, Vitest | Angular frontend with 100% test coverage |
| [sunroom-crm-react](https://github.com/runehand/sunroom-crm-react) | React 19, shadcn/ui, Vitest | React frontend with 100% test coverage |
...
```bash
git clone https://github.com/runehand/sunroom-crm-vue.git
cd sunroom-crm-vue
npm install
npm run dev
```
